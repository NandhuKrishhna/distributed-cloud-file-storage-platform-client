...
export const MyDrive = () => {
  ...
  const { directories, loading, error, currentDirectory } =
    useFetchAllDirectory(id, shouldRefresh);
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center h-96 text-center">
        ...
        <button
          onClick={() => navigate("/")}
          className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl font-medium shadow-lg shadow-blue-600/20 transition-all text-sm cursor-pointer inline-block flex items-center justify-center"
        >
          Go to Login
        </button>
      </div>
